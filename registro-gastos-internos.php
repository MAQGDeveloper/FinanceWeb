...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Registro Gastos Internos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Registro Gastos Internos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <h2>Listado de Gastos Internos:</h2>
  ...
  <!-- ./wrapper -->
  <?php
  echo '<script async src="assets/js/registro-gastos-internos.js?token='.date('YmdHis').'"></script>';
  ?>
</body>
</html>
